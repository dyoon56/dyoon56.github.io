				...
				<div class="event_app_borad_view">
					<table>
						...
						<tbody>
							...
							<tr class="table_hits">
								<td class="table_hits_td1">&nbsp;</td>
								<td class="table_hits_td2">&nbsp;</td>
				...
				<div class="gallery_list">
					...
					<div class="gallery_wrap">
						<ol>
							<li>
								<a href="#">
									<div class="gallery_preview_img">
										<img src="../images/sub/newsroom/gallery_ex.jpg" width="222" height="138" alt="">
									</div>
									<p class="title">2016년 창업활동 회의</p>
